...
// Fetch pending delete requests count for ES/SHS
$pending_delete_count = 0;
require_once "../../config/db.php";
$count_res = $conn->query("SELECT COUNT(*) as total FROM remittance_reports WHERE delete_status = 'pending' AND module_type = 'es_shs'");
if ($count_res) {
