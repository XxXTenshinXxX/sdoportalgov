...
if (isset($navigation_pages[$current_page]) && isset($_SESSION['user_id'])) {
    // Avoid double logging on refreshes within a short time (optional enhancement, but let's keep it simple for now)
...
<head>
    <meta charset="UTF-8">
    <title>Admin Dashboard - Schools Division Office</title>
