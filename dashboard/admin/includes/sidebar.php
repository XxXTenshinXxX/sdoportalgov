...
// Fetch pending delete requests count
$pending_delete_count = 0;
require_once "../../config/db.php";
$count_res = $conn->query("SELECT COUNT(*) as total FROM remittance_reports WHERE delete_status = 'pending'");
if ($count_res) {
...
<div class="sidebar d-flex flex-column">
    ...
    <nav class="nav flex-column mt-2">
        ...
        <a href="es-shs.php"
            class="nav-link <?php echo ($current_page == 'es-shs.php' || $current_page == 'es-shs-members.php') ? 'active' : ''; ?>">
            <i class="bi bi-building me-2"></i> ES/SHS
        </a>
        ...
        <a href="javascript:void(0);" onclick="switchApp('/sdo-portal/leave-monitoring', 'Leave Monitoring')" class="nav-link">
            <i class="bi bi-calendar-check me-2"></i> Leave Monitoring
        </a>
