    ...
    <div class="main-content">
        <div class="card card-modern p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="mb-0 text-danger fw-bold"><i class="bi bi-trash3-fill me-2"></i>Pending Delete Requests</h5>
                    ...
                    <table class="table table-hover align-middle text-center border">
                        ...
                        <tbody>
                            <?php foreach ($reports as $index => $row):
                                ...
                                if ($row['module_type'] === 'philhealth') {
                                    $module_display = 'PhilHealth';
                                    $module_class = 'bg-info text-dark';
                                } elseif ($row['module_type'] === 'es_shs') {
                                    $module_display = 'ES/SHS';
                                    $module_class = 'bg-success';
                                } elseif ($row['module_type'] === 'qes') {
                                    $module_display = 'QES';
                                    $module_class = 'bg-warning text-dark';
                                }
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><span class="badge <?php echo $module_class; ?>">
                                            <?php echo $module_display; ?>
                                        </span></td>
                                    <td>
