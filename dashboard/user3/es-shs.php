...
<body>
    ...
    <div class="main-content">
        <div class="card card-modern p-4">
            <div class="d-flex justify-content-between align-items-center mb-3 gap-3">
                <h5 class="mb-0">ES/SHS Remittance Reports</h5>
                <div class="d-flex align-items-center gap-3">
                    <!-- Year Filter -->
                    <div class="shadow-sm rounded-pill overflow-hidden border bg-white d-flex align-items-center px-2" style="height: 31px;">
                        <select id="yearFilter" class="form-select border-0 bg-transparent py-0 small" style="box-shadow: none; font-size: 0.85rem;" onchange="applyFilters()">
                        ...
                        <tbody class="small">
                            ...
                            foreach ($reports as $report): ?>
                                <tr data-report-id="<?php echo $report['id']; ?>">
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="badge rounded-pill px-3" style="background-color: #2e7d32 !important; color: white;">
                                            <?php
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="es-shs-members.php?id=<?php echo $report['id']; ?>"
                ...
                <nav aria-label="Page navigation" class="mt-4">
                    <ul class="pagination pagination-sm justify-content-center">
                        <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
                            <a class="page-link shadow-none" href="?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&year=<?php echo urlencode($year); ?>" tabindex="-1">
                                <i class="bi bi-chevron-left"></i> Previous
                            </a>
                        </li>
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                            <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                                <a class="page-link shadow-none" href="?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&year=<?php echo urlencode($year); ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        <li class="page-item <?php echo ($page >= $totalPages) ? 'disabled' : ''; ?>">
                            <a class="page-link shadow-none" href="?page=<?php echo $page + 1; ?>&search=<?php echo urlencode($search); ?>&year=<?php echo urlencode($year); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="delete-message">Are you sure you want to delete the selected report(s)?</p>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary text-white border-0 py-3">
                    <h5 class="modal-title" id="uploadReportModalLabel">
                        <i class="bi bi-cloud-arrow-up-fill me-2"></i>Upload ES/SHS Reports
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="save_remittance_report.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="module_type" value="es_shs">
    ...
    <!-- Scripts (Reused from PhilHealth) -->
    <script>
        ...
        document.querySelector('#uploadReportModal form').addEventListener('submit', async function (e) {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                formData.append('module_type', 'es_shs');
