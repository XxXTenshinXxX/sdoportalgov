...
$reportCheck = $conn->query("SELECT id FROM remittance_reports WHERE id = $report_id AND module_type = 'qes'")->num_rows;
if ($reportCheck == 0) {
    header("Location: qes.php");
    exit;
}
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="qes.php">QES Reports</a></li>
                        <li class="breadcrumb-item active" aria-current="page">View Members</li>
                    </ol>
                </nav>
                <a href="qes.php" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card card-modern mb-4">
                <div class="card-header bg-purple text-white d-flex justify-content-between align-items-center"
                    style="background-color: #6a1b9a !important;">
                    <h5 class="mb-0"><i class="bi bi-file-earmark-text me-2"></i>Remittance Report Details:
                        <?php echo $report['spa_no']; ?>
                    </h5>
                    <span class="badge bg-light text-purple" style="color: #6a1b9a !important;">
                        <?php
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-3 mb-md-0">
                            ...
                            <p class="mb-1"><strong>PhilHealth No:</strong>
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="d-flex justify-content-between pt-1">
                                ...
                                <strong class="fs-5" style="color: #6a1b9a !important;">₱
                                    <?php
                            ...
                            <table class="table table-hover align-middle mb-0" id="membersTable">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th class="text-center" width="15%">Status | Remarks</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr class="member-row"
                                            ...
                                            <td class="text-center">
                                                <?php if ($member['status'] == 'A'): ?>
                                                    <span
                                                        class="badge bg-purple-subtle text-purple border border-purple-subtle rounded-pill px-3"
                                                        style="background-color: rgba(106, 27, 154, 0.1) !important; color: #6a1b9a !important;">Active</span>
    ...
    <div class="modal fade" id="memberHistoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header text-white border-0 py-3" style="background-color: #6a1b9a !important;">
                ...
                <div class="modal-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead>
                                <tr style="background-color: #6a1b9a !important;">
