...
<?php
// Fetch pending delete requests for QES
$reports = [];
$result = $conn->query("SELECT r.*, u.username as uploader 
                       FROM remittance_reports r 
                       LEFT JOIN users u ON r.uploaded_by = u.id 
                       WHERE r.delete_status = 'pending' AND r.module_type = 'qes'
    ...
    <div class="main-content">
        <div class="card card-modern p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="mb-0 text-danger fw-bold"><i class="bi bi-trash3-fill me-2"></i>Pending QES Delete Requests
                </h5>
                        ...
                        <tbody>
                            <?php foreach ($reports as $index => $row): ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-warning text-dark">QES</span></td>
                                    <td>
