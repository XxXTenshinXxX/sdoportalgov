...
function getReasonShortcut($reason)
{
    ...
    foreach ($shortcuts as $full => $short) {
        if (strcasecmp(trim($reason), $full) === 0)
            return $short;
    }
    return $reason;
}
...
if ($level_filter == 'ES')
    $page_title = "Elementary (ES) Leave Records";
if ($level_filter == 'SEC')
    $page_title = "Secondary (SEC) Leave Records";
...
<div class="col-md-9 col-xl-10 ms-sm-auto main-wrapper">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="fw-bold m-0" style="color:#0a2f44;"><i class="fas fa-user-clock me-2"></i> <?php echo $page_title; ?>
        </h5>
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmployeeLeaveModal"
                style="background:#0a2f44; border:none;">
            ...
            <form method="GET" action="leave-monitoring.php" class="row g-3 align-items-end" id="filterForm">
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" name="search"
                            placeholder="Enter keywords..." value="<?php echo htmlspecialchars($search); ?>"
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" name="reason" onchange="this.form.submit()">
                        ...
                        <option value="Sick leave without pay" <?php if ($reason_filter == 'Sick leave without pay')
                            echo 'selected'; ?>>Sick leave (SWOP/SLWP)</option>
                        <option value="Vacation leave without pay" <?php if ($reason_filter == 'Vacation leave without pay')
                            echo 'selected'; ?>>Vacation leave (VWOP/VWP)</option>
                        <option value="Maternity leave" <?php if ($reason_filter == 'Maternity leave')
                            echo 'selected'; ?>>Maternity leave (ML)</option>
                        <option value="Study leave" <?php if ($reason_filter == 'Study leave')
                            echo 'selected'; ?>>Study
                            leave (STUDY)</option>
                        <option value="Wellness leave" <?php if ($reason_filter == 'Wellness leave')
                            echo 'selected'; ?>>
                            Wellness leave (WL)</option>
                        <option value="Special privilege leave" <?php if ($reason_filter == 'Special privilege leave')
                            echo 'selected'; ?>>Special privilege (SPL)</option>
                        <option value="Forced leave" <?php if ($reason_filter == 'Forced leave')
                            echo 'selected'; ?>>
                            Forced leave (FL)</option>
                        <option value="Others" <?php if ($reason_filter == 'Others')
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex gap-2">
                        <select class="form-select" name="status" onchange="this.form.submit()">
                            ...
                            <option value="Inactivation" <?php if ($status_filter == 'Inactivation')
                                echo 'selected'; ?>>
                                Inactivation</option>
                            <option value="Separation" <?php if ($status_filter == 'Separation')
                                echo 'selected'; ?>>
                                Separation</option>
                        </select>
                        <input type="hidden" name="level" value="<?php echo htmlspecialchars($level_filter); ?>">
                        <a href="leave-monitoring.php" class="btn btn-outline-secondary" title="Reset Filters"><i
    ...
    <div class="card shadow-sm border-0 mb-5">
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="leaveMonitoringTable" class="table table-bordered table-hover align-middle m-0 text-center"
                                    ...
                                    <td class="text-nowrap">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <button class="btn btn-sm btn-info text-white view-btn"
                                                title="View historical records" data-id="<?php echo $row['leave_id']; ?>"
                                                data-employee-id="<?php echo $row['employee_id']; ?>"
                                                data-surname="<?php echo htmlspecialchars($row['surname']); ?>"
                                                data-firstname="<?php echo htmlspecialchars($row['first_name']); ?>"
                                                data-mi="<?php echo htmlspecialchars($row['middle_initial']); ?>">
                                            ...
                                            <!-- ADD LEAVE -->
                                            <button class="btn btn-sm btn-success text-white add-leave-btn"
                                            ...
                                            <button class="btn btn-sm btn-primary text-white edit-employee-details-btn"
    ...
    <div class="modal fade" id="addEmployeeLeaveModal" tabindex="-1" aria-labelledby="addEmployeeLeaveModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background:#0a2f44; color:white;">
                    <h5 class="modal-title" id="addEmployeeLeaveModalLabel"><i class="fas fa-user-plus me-2"></i>Add
                        Employee</h5>
                ...
                <div class="modal-body">
                    <form id="employeeLeaveForm">
                        ...
                        <div id="employeeDetailsSection">
                            ...
                            <div class="row g-3 mb-3 mt-1">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="school_level" required>
                                        <option value="ES" <?php echo ($level_filter == 'ES') ? 'selected' : ''; ?>>
                                            Elementary (ES)</option>
                                        <option value="SEC" <?php echo ($level_filter == 'SEC') ? 'selected' : ''; ?>>
                                            Secondary (SEC)</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                            ...
                            <!-- Name Section -->
                            <h6
                                class="bg-light p-2 border-start border-secondary border-4 mb-3 fw-bold text-dark rounded-end">
                        ...
                        <div id="leaveParticularsSection" class="d-none">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control mt-2 d-none" name="other_reason"
                                        id="otherReason" placeholder="Please specify reason">
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control bg-light" name="total_days" id="totalDays"
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="button" class="btn btn-primary" id="saveLeaveBtn"
                        style="background:#0a2f44; border:none;"><i class="fas fa-save me-2"></i>Save Record</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0 shadow">
                <div class="modal-body p-4 bg-white text-dark"
                    style="font-family: Arial, sans-serif; font-size: 0.8rem; line-height: 1.2;">

                    <!-- Print Button & Close -->
                    <div class="d-flex justify-content-end mb-2 d-print-none gap-2">
                        <button type="button" class="btn btn-sm btn-success" id="addLeaveFromViewBtn"><i
                                class="fas fa-plus-circle"></i> Add Leave</button>
                        <button type="button" class="btn btn-sm btn-outline-secondary" onclick="printViewModal()"><i
                    ...
                    <div id="printableForm">
                        ...
                        <div class="text-end mb-2 pe-3">
                            Employee no: <span id="viewExcelEmpNo"
                                style="display:inline-block; min-width:100px; border-bottom:1px solid #000;"></span>
                        </div>
                        ...
                        <table class="table-borderless w-100 mb-4" style="border-collapse: collapse;">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center fw-bold fs-6"
                                        style="border-bottom: 2px solid #000; width: 20%;" id="viewExcelSurname"></td>
                                    <td class="text-center fw-bold fs-6"
                                        style="border-bottom: 2px solid #000; width: 25%;" id="viewExcelFirstName"></td>
                                    <td class="text-center fw-bold fs-6"
                                        style="border-bottom: 2px solid #000; width: 10%;" id="viewExcelMi"></td>
                                    <td style="width: 35%; padding-left: 10px; font-size: 0.75rem;">(If married woman,
                                        give<br>also full maiden name)</td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-center fs-6" style="border-bottom: 2px solid #000;"
                                        id="viewExcelDob"></td>
                                    <td class="text-center fs-6" style="border-bottom: 2px solid #000;"
                                        id="viewExcelPob"></td>
                                    <td style="padding-left: 10px; font-size: 0.75rem;">(Date herein should
                                        be<br>checked from birth/bap-<br>tismal certificate or some<br>reliable
                                        documents.)</td>
                                </tr>
                                <tr>
                                    <td></td>
                            ...
                            <!-- Filter Bar -->
                            <div class="row g-2 mb-3 d-print-none bg-light p-2 rounded shadow-sm border"
                                style="margin: 0 10px;">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    <select id="historyReasonFilter" class="form-select form-select-sm">
                                        ...
                                        <option value="Vacation leave without pay">Vacation leave without pay (VWOP)
                                        </option>
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-sm btn-outline-secondary w-100"
                                        id="resetHistoryFilters">Clear</button>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered border-dark text-center align-middle mb-4"
                                ...
                                <thead style="background-color: #f2f2f2; font-weight: bold;">
                                    <tr>
                                        <td colspan="2" style="border: 2px dotted #000;">PERIOD COVERED<br><span
                                                style="font-weight: normal;">(Inclusive Date)</span></td>
                                        <td rowspan="2" style="border: 2px dotted #000;">REASON</td>
                                        <td rowspan="2" style="border: 2px dotted #000;">STATION<br>PLACE
                                            OF<br>ASSIGNMENT</td>
                                        ...
                                        <td rowspan="2" class="d-print-none"
                                            style="border: 2px dotted #000; width: 80px;">ACTIONS</td>
                                    </tr>
                                    <tr>
                            ...
                            <!-- Footer details -->
                            <div class="mb-4 ps-2">
                                Issued in compliance with Executive Order No. 54 dated August 10, 1954 and in accordance
                                with Circular No. 58 dated August 10,<br>1954 of the system.
                            </div>
                            ...
                            <div class="row align-items-end mt-5 pt-3">
                                <div class="col-6">
                                    ...
                                    <div class="mt-4" style="width: 150px; text-align: center;">
                                        <div style="border-bottom: 1px solid #000; letter-spacing: 2px;"
                                            class="fw-bold">*********</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background:#ffc107; color:#212529;">
                    <h5 class="modal-title fw-bold" id="editLeaveModalLabel"><i class="fas fa-edit me-2"></i>Edit Leave
                        Record</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editLeaveForm">
                        ...
                        <div id="editEmployeeDetailsSection">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Employee No.</label>
                                    <input type="text" class="form-control" name="employee_no" id="editEmpNo"
                                        placeholder="Optional Employee Number">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">School Level</label>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Middle Initial</label>
                                    <input type="text" class="form-control" name="middle_initial" id="editMi"
                                        maxlength="2">
                                </div>
                            </div>
                        ...
                        <div id="editLeaveParticularsSection">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control mt-2 d-none" name="other_reason"
                                        id="editOtherReason" placeholder="Please specify reason">
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label fw-semibold">Total Days</label>
                                    <input type="text" class="form-control bg-light" name="total_days"
                                        id="editTotalDays" readonly placeholder="0">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Remarks</label>
                        ...
                        <div class="modal-footer bg-light mt-4 mx-n3 mb-n3 px-3 py-3 border-top">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn btn-warning fw-bold"><i class="fas fa-save me-2"></i>Update
                                Record</button>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="addLeaveParticularsModal" tabindex="-1" aria-labelledby="addLeaveParticularsModalLabel"
        aria-hidden="true" style="z-index: 1060;">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="addLeaveParticularsModalLabel"><i
                            class="fas fa-plus-circle me-2"></i>Add Leave Particulars</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                    ...
                    <form id="addLeaveParticularsForm">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="period_from" id="historyLeaveFrom"
                                    required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control mt-2 d-none" name="other_reason"
                                    id="historyOtherReason" placeholder="Please specify reason">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control bg-light" id="historyTotalDays" readonly
                                    placeholder="0">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="modal-footer bg-light">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-success" id="saveHistoryLeaveBtn"><i
                            class="fas fa-save me-2"></i>Save Leave Record</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-success text-white border-0">
                    <h5 class="modal-title" id="uploadExcelModalLabel"><i class="fas fa-file-excel me-2"></i>Upload
                        Leave Records</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <form id="uploadExcelForm" enctype="multipart/form-data">
                        <div class="mb-4">
                            ...
                            <input type="file" class="form-control" name="excel_file[]" id="excelFileInput"
                                accept=".xlsx, .xls" required multiple>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="upload_level" id="uploadLevelSelect">
                                    <option value="ES" <?php echo ($level_filter == 'ES') ? 'selected' : ''; ?>>Elementary
                                        (ES)</option>
                                    <option value="SEC" <?php echo ($level_filter == 'SEC') ? 'selected' : ''; ?>>
                                        Secondary (SEC)</option>
                                </select>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <p class="text-secondary mb-0">You are about to delete <span id="confirmDeleteCount"
                            class="fw-bold text-danger">0</span> selected record(s).<br>Deleted records can be viewed
                        and restored in the "Deleted" section.</p>
                </div>
                <div class="modal-footer bg-light border-0 justify-content-center">
                    <button type="button" class="btn btn-secondary px-4" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger px-4 fw-bold" id="confirmDeleteBtn">Yes, Delete
                        now</button>
                </div>
            </div>
        </div>
